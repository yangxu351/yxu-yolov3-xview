    ...
    for ix, mk in enumerate(model_maps.keys()):
        ...
        for batch_i, (imgs, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
            ...
            for si, pred in enumerate(output):
                ...
                #fixme --yang.xu
                # if opt.model_id is not None and opt.class_num == 1:
                ...
                if nl:
                    ...
                    for cls in torch.unique(tcls_tensor):
                        ...
                        #fixme --yang.xu
                        # if with_modelid and opt.class_num == 1:
        ...
        if len(stats):
            ...
            # p, r, ap, f1, ap_class = ap_per_class_pr_roc(*stats, pr_path=opt.result_dir, pr_name= pr_name, model_id=opt.model_id)
            # if niou > 1:
...
def get_opt(dt=None, sr=None, comments=''):
    ...
    parser.add_argument('--model_id', type=int, default=None, help='class number')
