...
def check_prd_gt_iou_xview_syn(data_file, cc_id, sorc, cmt, prefix, res_folder, base_pxwhrs='px23whr3_seed17', hyp_cmt = 'hgiou1_1gpu', seed=17, iou_thres=0.5):
...
#    res_folder = 'test_on_ori_nrcbkg_aug_rc_{}_m{}_rc{}_{}_iou{}'
    res_folder = 'test_on_xview_nccbkg_aug_cc_{}_{}_iou{}_seed{}'.format(hyp_cmt, eht, apN, sd)
    data_file = 'xview_nccbkg_aug_cc{}_test_{}.data'.format(cc_id, base_pxwhrs)

    for eh in ['easy']: # 'hard', 
        d_file = data_file
        r_folder = res_folder
        for cmt in comments:
            check_prd_gt_iou_xview_syn(d_file, cc_id, sorc, cmt, prefix, r_folder, base_pxwhrs=base_pxwhrs, hyp_cmt=hyp_cmt, seed=seed, iou_thres=iou_thres)
