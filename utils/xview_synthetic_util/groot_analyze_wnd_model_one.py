...
def get_part_syn_args():
    ...
    parser.add_argument("--data_wnd_dir", type=str, help="to save data files",
                        default='/data/users/yang/code/yxu-yolov3-xview/data_wnd/')
...
def check_prd_gt_iou_xview_syn(data_file, miss_model_id, rare_class, cmt, prefix, res_folder, base_pxwhrs='px23whr3_seed17', hyp_cmt = 'hgiou1_1gpu', seed=17, iou_thres=0.5):
    xview_dir = os.path.join(syn_args.data_wnd_dir, base_pxwhrs)
...
#    res_folder = 'test_on_xview_{}_m{}_rc{}_{}_iou20'
    ...
    base_pxwhrs = 'px10_seed17'
    data_file = 'wndtest_{}.data'
#    res_folder = 'test_on_wnd_{}_{}'
    res_folder = 'test_on_wnd_{}_wnd_backup{}_ap{}'
...
#        r_folder = res_folder.format(hyp_cmt, miss_model_id, rare_class, eh)
        d_file = data_file.format(base_pxwhrs)
        r_folder = res_folder.format(hyp_cmt, bkup, apN)
        for cmt in comments:
