...
##        cmt = 'xbw_xbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_bxmuller_size_bias{}_RC1_v{}'.format(ssig, ix+1)
##        px_thres = 15
##        cmt = 'xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_bxmuller_size_bias{}_RC2_v{}'.format(ssig, ix+1)
##        px_thres = 23
##        cmt = 'xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_bxmuller_size_bias{}_RC3_v{}'.format(ssig, ix+1)
##        px_thres = 23
#        cmt = 'xbw_xcolor_xbkg_unif_shdw_split_scatter_gauss_rndsolar_bxmuller_size_bias{}_RC4_v{}'.format(ssig, ix+1)
#        px_thres = 23
##        cmt = 'xbw_xcolor_xbkg_unif_shdw_split_scatter_gauss_rndsolar_bxmuller_size_bias{}_RC5_v{}'.format(ssig, ix+1)
##        px_thres = 23

#    size_sigma = [0, 0.03, 0.06, 0.09, 0.12] # 0,
#    for ix,ssig in enumerate(size_sigma):
#        cmt = 'xbw_xbkg_unif_mig21_shdw_split_scatter_gauss_rndsolar_bxmuller_promu_size_bias{}_RC1_v{}'.format(ssig, ix+21) 
#        px_thres = 15
#        cmt = 'xbsw_xwing_xbkg_shdw_split_scatter_gauss_rndsolar_bxmuller_promu_size_bias{}_RC2_v{}'.format(ssig, ix+21)
#        px_thres = 23
#        cmt = 'xbw_xbkg_unif_shdw_split_scatter_gauss_rndsolar_bxmuller_promu_size_bias{}_RC3_v{}'.format(ssig, ix+21)
#        px_thres = 23
#        cmt = 'xbw_xcolor_xbkg_unif_shdw_split_scatter_gauss_rndsolar_bxmuller_promu_size_bias{}_RC4_v{}'.format(ssig, ix+21)
#        px_thres = 23
